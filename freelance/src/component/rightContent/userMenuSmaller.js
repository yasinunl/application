...
const UserMenuSmaller = () => {
  ...
  ////////////////////////////////////////////////////////////////////////
  return (
    <div id="user-sidebar" className={`lg:flex ${!openHideR ? "hidden" : ""}`}>
      <aside
          ...
          {success ? (
            <ul className="space-y-2">
              ...
              <li>
                <button
                  type="button"
                  onClick={() => openHideDropdown("smallinbox")}
                ...
                <div id="smallinbox" className="hidden">
              ...
              <li>
                <button
                  type="button"
                  onClick={() => openHideDropdown("smallsendBox")}
                ...
                <div id="smallsendBox" className="hidden">
                  <ul className="py-2 space-y-2">
...
export default UserMenuSmaller;
